...
/** Generated Model for TF_Tyre_RBReceipt
 *  @author iDempiere (generated) 
 *  @version Release 3.1 - $Id$ */
public class X_TF_Tyre_RBReceipt extends PO implements I_TF_Tyre_RBReceipt, I_Persistent 
{
    ...
    public X_TF_Tyre_RBReceipt (Properties ctx, int TF_Tyre_RBReceipt_ID, String trxName)
    {
      super (ctx, TF_Tyre_RBReceipt_ID, trxName);
      /** if (TF_Tyre_RBReceipt_ID == 0)
        {
			setC_BPartner_ID (0);
...
// DR
    ...
    /** Load Constructor */
    public X_TF_Tyre_RBReceipt (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TF_Tyre_RBReceipt[")
	...
	/** Set TF_Tyre_RBReceipt_UU.
		@param TF_Tyre_RBReceipt_UU TF_Tyre_RBReceipt_UU	  */
	public void setTF_Tyre_RBReceipt_UU (String TF_Tyre_RBReceipt_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TF_Tyre_RBReceipt_UU, TF_Tyre_RBReceipt_UU);
	}

	/** Get TF_Tyre_RBReceipt_UU.
		@return TF_Tyre_RBReceipt_UU	  */
	public String getTF_Tyre_RBReceipt_UU () 
	{
		return (String)get_Value(COLUMNNAME_TF_Tyre_RBReceipt_UU);
	}
}