...
/** Generated Model for TF_SalaryHdr
 *  @author iDempiere (generated) 
 *  @version Release 5.1 - $Id$ */
public class X_TF_SalaryHdr extends PO implements I_TF_SalaryHdr, I_Persistent 
{
    ...
    public X_TF_SalaryHdr (Properties ctx, int TF_SalaryHdr_ID, String trxName)
    {
      super (ctx, TF_SalaryHdr_ID, trxName);
      /** if (TF_SalaryHdr_ID == 0)
        {
			...
			setProcessed (false);
// N
			setTF_SalaryHdr_ID (0);
        } */
    }

    /** Load Constructor */
    public X_TF_SalaryHdr (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TF_SalaryHdr[")
	...
	/** Set TF_SalaryHdr_UU.
		@param TF_SalaryHdr_UU TF_SalaryHdr_UU	  */
	public void setTF_SalaryHdr_UU (String TF_SalaryHdr_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TF_SalaryHdr_UU, TF_SalaryHdr_UU);
	}

	/** Get TF_SalaryHdr_UU.
		@return TF_SalaryHdr_UU	  */
	public String getTF_SalaryHdr_UU () 
	{
		return (String)get_Value(COLUMNNAME_TF_SalaryHdr_UU);
	}
