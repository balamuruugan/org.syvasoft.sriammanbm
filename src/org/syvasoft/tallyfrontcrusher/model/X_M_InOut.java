...
// 5
	...
	/** Set Barcode Scanner.
		@param BarcodeScanner_CLines Barcode Scanner	  */
	public void setBarcodeScanner_CLines (String BarcodeScanner_CLines)
	{
		set_Value (COLUMNNAME_BarcodeScanner_CLines, BarcodeScanner_CLines);
	}

	/** Get Barcode Scanner.
		@return Barcode Scanner	  */
	public String getBarcodeScanner_CLines () 
	{
		return (String)get_Value(COLUMNNAME_BarcodeScanner_CLines);
	}
	...
	/** Job Order Receipts = J+ */
	public static final String MOVEMENTTYPE_JobOrderReceipts = "J+";
	/** Job Order Shipments = J- */
	public static final String MOVEMENTTYPE_JobOrderShipments = "J-";
	/** Set Movement Type.
		@param MovementType 
