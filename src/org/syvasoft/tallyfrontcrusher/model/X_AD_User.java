...
// E
	...
	/** Set Weighment Admin.
		@param WeighmentAdmin Weighment Admin	  */
	public void setWeighmentAdmin (boolean WeighmentAdmin)
	{
		set_Value (COLUMNNAME_WeighmentAdmin, Boolean.valueOf(WeighmentAdmin));
	}

	/** Get Weighment Admin.
		@return Weighment Admin	  */
	public boolean isWeighmentAdmin () 
	{
		Object oo = get_Value(COLUMNNAME_WeighmentAdmin);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
