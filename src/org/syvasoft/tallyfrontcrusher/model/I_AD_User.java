...
public interface I_AD_User 
{
    ...
    /** Column name WeighmentAdmin */
    public static final String COLUMNNAME_WeighmentAdmin = "WeighmentAdmin";

	/** Set Weighment Admin	  */
	public void setWeighmentAdmin (boolean WeighmentAdmin);

	/** Get Weighment Admin	  */
	public boolean isWeighmentAdmin();

    /** Column name WeighmentEnabled */
    public static final String COLUMNNAME_WeighmentEnabled = "WeighmentEnabled";
